...
\begin{frame}
	...
	\begin{columns}[c]
		\begin{column}{30cm}
			...
			\begin{itemize}
				\justifying
				\item A \textcolor{TextGreen}{thing}, in the Internet of Things, can be any natural or man-made\\
				object can be assigned \textcolor{TextGreen}{IP address}.
...
\begin{frame}
	\frametitle{IoT OS}
	\vspace{.5cm}
	\hspace*{1.5cm} \includegraphics[width=10cm]{figs/mbed-components.png}
\end{frame}
...
%------------------------------------------------
\begin{frame}
	\frametitle{Test \& Development Environments}
	\begin{columns}[c]
		\begin{column}{30cm}
			\vspace{.1cm}
			\begin{itemize}
