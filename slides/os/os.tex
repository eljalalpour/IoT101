	...
	\begin{columns}[c]
		\begin{column}{30cm}
			...
			\begin{itemize}
				...
				\item Under-development protocols
				\begin{itemize}
					\item IEEE802.15.4e
					\item IETF 6TiSCH 
					\item IETF 6LoWPAN
...
\begin{frame}
	...
	%\includegraphics[width=5cm]{figs/iot-lab-2.png}	
...
\begin{frame}
	...
	\begin{itemize}
		\justifying
		\item Different applications of IoT $\Rightarrow$ Different OS Requirements (e.g., Energy, Memory, Realtime, ...) $\Rightarrow$ Different OSs
		\item A few OSs should be examined
